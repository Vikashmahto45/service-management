...
<div class="row mb-4 align-items-center">
    <div class="col-md-6">
        <h1><i class="fas fa-edit text-primary mr-2"></i>Edit Customer Product</h1>
        <p class="text-muted mb-0">Update appliance details</p>
    </div>
...
<div class="card-box px-4 py-4">
    <form action="<?php echo URLROOT; ?>/customerProducts/edit/<?php echo $data['id']; ?>" method="POST">
        <div class="row">
            <!-- Left Column -->
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="model_no" class="form-control" value="<?php echo $data['model_no']; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-4">
            ...
            <div class="col-12">
                <div class="form-group mb-4">
                    ...
                    <textarea name="specifications" id="specifications" class="form-control" rows="4"><?php echo $data['specifications']; ?></textarea>
                </div>
            </div>
        </div>
