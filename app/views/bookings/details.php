...
<div class="row mb-4 align-items-center">
    ...
    <div class="col-md-6 text-right">
        ...
        ?>
        <span class="badge <?php echo $statusBadge[$data['booking']->t_status] ?? 'badge-secondary'; ?> p-2 px-3 shadow-sm mr-2" style="font-size: 1rem;">
            <?php echo strtoupper($data['booking']->t_status); ?>
        </span>
                ...
                <div class="tab-pane fade show active" id="overview" role="tabpanel">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <?php if($data['booking']->tech_name != 'Unassigned'): ?>
                                <p class="mb-1 text-primary"><strong>Assigned to:</strong> <?php echo $data['booking']->tech_name; ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <form action="<?php echo URLROOT; ?>/bookings/update_status/<?php echo $data['booking']->id; ?>" method="POST">
                ...
                <div class="form-group">
                    <select name="status" id="status_selector" class="form-control form-control-sm mb-3">
                        <option value="pending" <?php echo ($data['booking']->t_status == 'pending') ? 'selected' : ''; ?>>Pending</option>
                        <option value="confirmed" <?php echo ($data['booking']->t_status == 'confirmed') ? 'selected' : ''; ?>>Confirmed</option>
                        <option value="assigned" <?php echo ($data['booking']->t_status == 'assigned') ? 'selected' : ''; ?>>Assigned</option>
                        <option value="in_progress" <?php echo ($data['booking']->t_status == 'in_progress') ? 'selected' : ''; ?>>In Progress</option>
                        <option value="completed" <?php echo ($data['booking']->t_status == 'completed') ? 'selected' : ''; ?>>Completed</option>
                        <option value="cancelled" <?php echo ($data['booking']->t_status == 'cancelled') ? 'selected' : ''; ?>>Cancelled</option>
                    </select>
