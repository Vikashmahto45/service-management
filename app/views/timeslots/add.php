...
<div class="row mb-4 align-items-center">
    <div class="col-md-6">
        <h1><i class="fas fa-plus-circle text-primary mr-2"></i>Add Time Slot</h1>
        <p class="text-muted mb-0">Create a new scheduling window</p>
    </div>
...
<div class="card-box" style="max-width: 600px;">
    <form action="<?php echo URLROOT; ?>/timeslots/add" method="POST">
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-primary px-4 shadow-sm">Save Time Slot</button>
